"""
Написание тестов не входит в задание, так что прошу не проверять)
Так как тесты я использоввал для отладки и проверки что ничего не сломал пока дорабатываю,
понимаю что их нужно дорабатывать. Сохранил для истории, вдруг помогут еще
"""
